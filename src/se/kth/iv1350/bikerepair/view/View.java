...
public class View {
    ...
    /**
     * Creating a new view that talks to the given controller.
     *
    ...
    /**
     * This will Run the hardcoded flow: from start to acceptance, printing
    ...
    /**
     * Encapsulation was added to avoid println lines 6 times
     */
